...
class PetFriends:
    ...
    def update_pet_info(self, auth_key: json, pet_id: str, name: str,
        ...
        """Эта та часть кода  отвечате за задиние 19.7.2 , метод creat_pet_simple"""
...
def test_unssuccesfull_add_new_pet_without_photo(name='random', animal_type='двортерьер',age='13', pet_photo=''):
...
def test_unssuccsesfull_add_new_pet_without_uncorrect_age_type(name='asdasd', animal_type='дfasрьер',
                                     age='gvhjbhbbblj', pet_photo='images/cat1.jpg'):
...
def test_unssuccsesfull_add_realy_old_pet(name='sadfasd', animal_type='rahsdfjk',
                                     age='100000', pet_photo='images/cat1.jpg'):
...
def test_unssuccsesfull_get_api_key_with_wrong_email(email='hgdfsgdfg@mail.ru', password=valid_password):
...
def test_unssuccsesfull_create_pet_without_photo_with_invalid_key (name='Оксана', animal_type='минипиг',
                                                  age='3'):
    ...
    # Добавляем питомца
    status, result = pf.create_pet_simple({'key': 'dsdfsdfsdfsdfsd'}, name, animal_type, age)
